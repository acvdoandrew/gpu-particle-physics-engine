...
int main() {
  ...
  const uint32_t maxParticles = 10000; // Let's test with a high number
  //
  // Create main window
  ...
  particleVertices.setPrimitiveType(sf::PrimitiveType::Points);
